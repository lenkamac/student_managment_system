...
class AgeCalculator(QWidget):
    def __init__(self):
        ...
        date_birth_label = QLabel('Dateirth MM/DD/YYYY: ')
        self.date_birth__line_edit = QLineEdit()
        ...
        grid.addWidget(self.date_birth__line_edit, 1, 1)
    ...
    def calculate_age(self):
        ...
        date_of_birth = self.date_birth__line_edit.text()
